...
class ForgetPwdView(View):
    ...
    def post(self,request):
        foget_form=ForgetForm(request.POST)
        if foget_form.is_valid():
            email = request.POST.get("email", "")
            send_register_email(email, "forget")
            return render(request, "send_success.html")
        else:
            return render(request, "forgetpwd.html", {"forget_form": foget_form})
...
class ModifyPwdView(View):
    ...
    def post(self, request):
        ...
        if modify_form.is_valid():
            ...
            email = request.POST.get("email", "")
            return render(request, "password_reset.html", {"email": email, "modify_form":ModifyPwdForm() })
...
class MyCoureseView(LoginRequiredMixin,View):
    """
    我的课程
    """
    def get(self,request):
